...
# configuration of the data indestion cofig
...
class DataIngestion:
    ...
    def export_data_into_featur_store(self,dataframe:pd.DataFrame):
        try:
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataingestionartificat=DataIngestionArtifact(trained_file_path=self.data_ingestion_config.training_file_path,tested_file_path = self.data_ingestion_config.testing_file_path)
